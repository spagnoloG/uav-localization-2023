...
def main():
    ...
    drone_image_path = os.path.join(
        res_directory,
        "validation_drone_59e881f6e2da029497840f7a81f809f0cf6224b3-0-0.png",
    )
    sat_image_path = os.path.join(
        res_directory, "validation_sat_59e881f6e2da029497840f7a81f809f0cf6224b3-0-0.png"
    )
